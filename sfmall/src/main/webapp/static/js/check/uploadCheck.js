			...
			FilesAdded: function(up, files) {
				plupload.each(files, function(file) {
					makeThumb(file, function (imgsrc) {
	                    ...
	                    html = '<div id="'+file.id+'" style="margin-left: 15px; margin-top: -2px;">' +
...
//身份证正面
var uploaderZ = uploader("uploadImgZ","uploadZ","z_file");
uploaderZ.init();
//身份证反面
var uploaderF = uploader("uploadImgF","uploadF","f_file");
uploaderF.init();
//银行开户许可证
var uploaderB = uploader("uploadImgB","uploadB","b_file");
uploaderB.init();
//三证合一
var uploaderT = uploader("uploadImgT","uploadT","t_file");
uploaderT.init();
//组织机构代码证
var uploaderO = uploader("uploadImgO","uploadO","o_file");
uploaderO.init();
//纳税登记证
var uploaderTax = uploader("uploadImgTax","uploadTax","tax_file");
uploaderTax.init();
//营业执照副本
var uploaderL = uploader("uploadImgL","uploadL","l_file");
uploaderL.init();