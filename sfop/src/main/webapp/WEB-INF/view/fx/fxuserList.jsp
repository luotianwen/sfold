						...
						<div class="ibox-content">
							...
							<div class="input-group">
								<div class="col-md-2 m-b-xs">
									<input placeholder="会员id" name="recommend_userid" class="input form-control">
								</div>
								<div class="col-md-3 m-b-xs">
									<input placeholder="会员名称" name="uname" class="input form-control">
								</div>
								<div class="col-md-2 m-b-xs">
									<input placeholder="分销商id" name="recommended_userid" class="input form-control">
								</div>
								<div class="col-md-3 m-b-xs">
									<input placeholder="分销商名称" name="name" class="input form-control">
								</div>
								<div class="col-md-2">
