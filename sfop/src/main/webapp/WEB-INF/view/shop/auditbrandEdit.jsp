							...
							<table class="table table-striped">
	                            ...
	                            <tbody v-if="shopbrand!=null">
									...
									<tr>
                                        ...
                                        <td style="font-size: 12px;">品牌资质电子版：{{shopbrand.qualification_img}}</td>
                                    </tr>
                                    <tr>
		                                <td style="font-size: 12px;">
		                                	品牌首字母：
                                        ...
                                        <td style="font-size: 12px;">
                                        	...
                                        	<span v-if="shopbrand.brand==null">
												<select id="type" style="width: 60px;height: 30px;" name="type">
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 12px;">
                                        	经营类型：
                                        	<span v-if="shopbrand.brand==null">
												<select id="businesstype" style="width: 60px;height: 30px;" name="businesstype">
						...
						if(_this.option==0){
							if(b_brand_id==0){
								...
								layer.confirm('系统不存在该品牌，您可以新增该品牌或选择系统已存在品牌。', {
									...
									_this.option = 2;
									$.post("shopbrand/findAllShopBrandByShop.json",{s_merchants_id:id},function(data) {
										var html="";
										data["brands"].forEach(function (item) {
											if(item.s_merchants_id==null){
												html += '<li style="width: 25%;float: left;height: 30px;list-style: none"  >'+
														'	<input type="radio" name="brand_id" value="'+item.b_brand_id+'"/>'+item.name+
														'</li>';
											}
										});
										$("#temp").html(html);
