        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <label class="radio-inline">
                    <input type="radio" name="isFree"  required id="isFree1" value="1">  是
                </label>
                <label class="radio-inline">
                    <input type="radio" name="isFree" required id="isFree2" value="2">  否
                </label>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <div class="col-md-12 oper-area">
                    ...
                    <span name="defaultFirstUnitText">件内，</span>
                    ...
                    <span name="defaultAddUnitText">件，增加运费</span>
