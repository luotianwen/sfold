			...
			<div class="order_form">
					...
					<table style="width: 50%;">
						<tbody>
							...
							<tr>
								...
								<td><input id="expressNumber" maxlength="30" name="expressNumber" type="number"/></td>
							</tr>
						</tbody>
					</table>
				</form>
				...
				<table class="table_list_02" style="width: 100%;">
					...
					<tbody>
						...
						<c:forEach items="${orderInfo.orderInfos }" var="orderc">
							<c:forEach items="${orderc.orderDetailInfos }" var="detail">
								<tr>
									<td>
										<a href="商品详情">
