			...
			<div class="form-info">
				<form class="form-horizontal" id="info">
					...
					<c:forEach items="${propertycategory }" var="item" varStatus="var">
						<div class="form-group">
							<c:if test="${item.ismultiple==1 }">
								<label class="col-sm-2 control-label">${item.name }：<input type="hidden" name="productPropertys[${var.index }].propertyId" value="${item.id }"/></label>
								<div class="col-sm-10">
									<c:forEach items="${item.propertyvalue }" var="value">
										<c:set var="check" value=""/>
										<c:forEach items="${product.productPropertys }" var="proitem">
											<c:if test="${proitem.propertyId==item.id }">
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<input class="form-control inline" placeholder="" min="0" max="10000" value="${product.length }" name="length" type="number" style="width: 150px">
						...
						<div class="col-sm-2">
							<input class="form-control inline" placeholder="" min="0" max="10000" value="${product.width }" name="width" type="number" style="width: 150px">
							<span class="unit-inline">mm</span>
						</div>
						<label class="col-sm-2 control-label">
							【包装】高：
						...
						<div class="col-sm-2">
							<input class="form-control inline" placeholder="" min="0" max="10000" value="${product.highly }" name="highly" type="number" style="width: 150px">
							<span class="unit-inline">mm</span>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<select class="form-control" name="origin" style="width: 75%">
