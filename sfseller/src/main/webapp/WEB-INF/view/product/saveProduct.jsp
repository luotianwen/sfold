			...
			<div class="form-info">
				<form class="form-horizontal" id="info">
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<input class="form-control inline" placeholder="" min="0" max="1" name="length" type="number" style="width: 150px">
						...
						<div class="col-sm-2">
							<input class="form-control inline" placeholder="" min="0" name="width" type="number" style="width: 150px">
							<span class="unit-inline">mm</span>
						</div>
						<label class="col-sm-2 control-label">
							【包装】高：
						...
						<div class="col-sm-2">
							<input class="form-control inline" placeholder="" min="0" name="highly" type="number" style="width: 150px">
							<span class="unit-inline">mm</span>
						</div>
