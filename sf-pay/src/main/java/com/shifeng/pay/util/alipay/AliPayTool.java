...
public class AliPayTool {
	...
	public static String createAppPayReq(UnpaidOrderInfo orderInfo){
		String req = null;
		//实例化客户端
		AlipayClient alipayClient = new DefaultAlipayClient("https://openapi.alipay.com/gateway.do", AlipayConfig.partner
				, AlipayConfig.private_key, "json", AlipayConfig.input_charset, AlipayConfig.alipay_public_key, "RSA2");
