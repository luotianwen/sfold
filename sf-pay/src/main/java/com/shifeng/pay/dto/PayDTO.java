...
public class PayDTO {
	...
	public boolean isWapNotEmpty(){
		if(StringUtils.isNotBlank(payment_type) && StringUtils.isNotBlank(payment_method) /*&& StringUtils.isNotBlank(payment_code)*/
				&& StringUtils.isNotBlank(order_type) && StringUtils.isNotBlank(order_id)  && StringUtils.isNotBlank(openid) && StringUtils.isNotBlank(sign)){
			return true;
		}
		return false;
	}
	...
	public boolean checkSign(){
		if(Objects.equal(sign, MD5Util.hexSALT(payment_type+payment_method+order_type/*+payment_code*/+order_id))){
			return true;
		}
		return false;
	}
	...
	public boolean checkWapSign(){
		if(Objects.equal(sign, MD5Util.hexSALT(payment_type+payment_method+order_type/*+payment_code*/+order_id+openid))){
			return true;
		}
		return false;
	}
