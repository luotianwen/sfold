...
*/
			...
			if("TRADE_FINISHED".equals(trade_status) || "TRADE_SUCCESS".equals(trade_status)){
				...
				try {
					...
					if(order != null){//订单未处理
						...
						if(Objects.equal(AlipayConfig.seller_id, paymentRecord.getSeller_id())
								&& Objects.equal(order.getTotal_fee(),paymentRecord.getTotal_fee())){
							//更新订单支付状态
							try {
						...
						logger.info(extra_common_param+"订单："+out_trade_no+"已处理");
					}
				} catch (Exception e) {
					return_data = "fail";
					//out.print("fail");
	...
	public ModelAndView returns(HttpServletRequest request,ModelAndView mv,AlipayPaymentRecord paymentRecord){
