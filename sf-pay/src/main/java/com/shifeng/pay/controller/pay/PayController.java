				...
				System.out.println(orderInfo.toString());
				 switch (payDTO.getPayment_type()) {
					...
					case PaymentType.WEIXINPAY://微信支付
						...
						PayResData payResData = WeiXinPayTool.createPayReq(orderInfo,WeiXinPayTool.TRADETYPE_NATIVE);
					...
					System.out.println(payDTO.toString());
					 switch (payDTO.getPayment_type()) {
						...
						case "weixinpay"://微信支付
							...
							PayResData payResData = WeiXinPayTool.createPayReq(orderInfo,WeiXinPayTool.TRADETYPE_JSAPI);
