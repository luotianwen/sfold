...
public class WareSkuInfo implements Serializable {
	...
	public String toString() {
		return "WareSkuInfo [sku=" + sku + ", pid=" + pid + ", stocks=" + stocks + ", marketprice=" + marketprice
				...
				+ activitytype + ", activityprice=" + activityprice + ", activitystocks=" + activitystocks + ", imgs="
				+ imgs + ", shopid=" + shopid + ", shopName=" + shopName + ", shopLogo=" + shopLogo + ", brandid="
				+ brandid + ", pName=" + pName + ", recommend=" + recommend + ", listing=" + listing + ", parameter="
				+ parameter + ", state=" + state + ", after_service=" + after_service + ", freight_master="
				+ freight_master + ", goods_subtitle=" + goods_subtitle + ", logo=" + logo + ", length=" + length
				+ ", width=" + width + ", height=" + height + ", is_seven_return=" + is_seven_return + ", description="
				+ description + ", phone_describe=" + phone_describe + "]";
	}
