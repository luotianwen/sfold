...
public class SkuInfo implements Serializable {
	...
	public String toString() {
		return "SkuInfo [sku=" + sku + ", pid=" + pid + ", stocks=" + stocks + ", marketprice=" + marketprice + ", price="
				+ price + ", colorid=" + colorid + ", colorName=" + colorName + ", specid=" + specid + ", specName="
				+ specName + ", starttime=" + starttime + ", endtime=" + endtime + ", activitytype=" + activitytype
				+ ", activityprice=" + activityprice + ", activitystocks=" + activitystocks + ", colorPic=" + colorPic
				+ ", imgs=" + imgs + "]";
	}
