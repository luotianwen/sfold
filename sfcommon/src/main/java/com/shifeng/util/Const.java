...
public class Const {
     ...
     * sku缓存标识
     */
    public static final String SKU_CACHE_FLAG= "sku:cache:flag";
    public static final String SKU_DETAIL_CACHE="sku:detail:%s";
    public static final int SKU_DETAIL_CACHE_TIME=60*60*24;
    /**
     * 商品缓存标识
     */
    public static final String PRODUCT_CACHE_FLAG= "product:cache:flag";
    public static final String PRODUCT_DETAIL_CACHE= "product:detail:%s";
    public static final int PRODUCT_DETAIL_CACHE_TIME=60*60*24;
    //品牌缓存
    public static final String BAND_DETAIL_CACHE= "brand:detail:%s";
    public static final String BAND_CACHE_FLAG= "brand:cache:flag";
