            ...
            <div class="id_num">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <form:input cssClass="required error_border" placeholder="手机号" cssErrorClass="error" id="username" size="25" tabindex="1" accesskey="${userNameAccessKey}" path="username" autocomplete="off" htmlEscape="true" />
                    </c:otherwise>
                </c:choose>
            </div>
            <div class="psd_num">
